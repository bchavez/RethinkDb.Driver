...
### Getting Help
###### Commercial Support
Independent commercial support and consulting are available for this ***community driver***. To ensure best practices in .NET, proper driver usage, training, and critical bug fixes for the **C#** ***community driver*** contact [**Brian Chavez**](https://github.com/bchavez) ([twitter](https://twitter.com/bchavez), [email](https://github.com/bchavez)) for more information. Commercial support for **RethinkDB** ***server*** out-of-scope of the **C#** ***community driver*** can be found [here](http://rethinkdb.com/services/). 
