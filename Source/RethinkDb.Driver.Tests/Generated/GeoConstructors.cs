    ...
    public class GeoConstructors : GeneratedTest {
        ...
        public void YamlTest(){
             ...
             
             {
                 ...
                 var expected = new MapObject().with("$reql_type$", "GEOMETRY").with("coordinates", Arrays.asList(0, -90)).with("type", "Point");
             ...
             
             {
                 ...
                 var expected = new MapObject().with("$reql_type$", "GEOMETRY").with("coordinates", Arrays.asList(-180, 0)).with("type", "Point");
             ...
             
             {
                 ...
                 var expected = err("ReqlQueryLogicError", "Latitude must be between -90 and 90.  Got -91.", Arrays.asList(0));
             ...
             
             {
                 ...
                 var expected = err("ReqlQueryLogicError", "Longitude must be between -180 and 180.  Got -181.", Arrays.asList(0));
             ...
             
             {
                 ...
                 var expected = err("ReqlQueryLogicError", "Invalid LineString.  Are there antipodal or duplicate vertices?", Arrays.asList(0));
                 
                 //Original: r.line([0,0], [0,0])
                 var obtained = runOrCatch( r.line(Arrays.asList(0, 0), Arrays.asList(0, 0)) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( r.line(Arrays.asList(0, 0), Arrays.asList(0, 1)) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
             ...
             
             {
                 ...
                 var expected = err("ReqlQueryLogicError", "Expected point coordinate pair.  Got 1 element array instead of a 2 element one.", Arrays.asList(0));
                 
                 //Original: r.line([0,0], [1])
                 var obtained = runOrCatch( r.line(Arrays.asList(0, 0), Arrays.asList(1)) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
             ...
             
             {
                 ...
                 var expected = err("ReqlQueryLogicError", "Expected point coordinate pair.  Got 3 element array instead of a 2 element one.", Arrays.asList(0));
                 
                 //Original: r.line([0,0], [1,0,0])
                 var obtained = runOrCatch( r.line(Arrays.asList(0, 0), Arrays.asList(1, 0, 0)) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
             ...
             
             {
                 ...
                 var expected = new MapObject().with("$reql_type$", "GEOMETRY").with("coordinates", Arrays.asList(Arrays.asList(0, 0), Arrays.asList(0, 1), Arrays.asList(0, 0))).with("type", "LineString");
                 
                 //Original: r.line([0,0], [0,1], [0,0])
                 var obtained = runOrCatch( r.line(Arrays.asList(0, 0), Arrays.asList(0, 1), Arrays.asList(0, 0)) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
             ...
             
             {
                 ...
                 var expected = err("ReqlQueryLogicError", "Expected geometry of type `Point` but found `LineString`.", Arrays.asList(0));
                 
                 //Original: r.line(r.point(0,0), r.point(1,0), r.line([0,0], [1,0]))
                 var obtained = runOrCatch( r.line(r.point(0, 0), r.point(1, 0), r.line(Arrays.asList(0, 0), Arrays.asList(1, 0))) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
             ...
             
             {
                 ...
                 var expected = err("ReqlQueryLogicError", "Invalid LinearRing.  Are there antipodal or duplicate vertices? Is it self-intersecting?", Arrays.asList(0));
                 
                 //Original: r.polygon([0,0], [0,0], [0,0], [0,0])
                 var obtained = runOrCatch( r.polygon(Arrays.asList(0, 0), Arrays.asList(0, 0), Arrays.asList(0, 0), Arrays.asList(0, 0)) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( r.polygon(Arrays.asList(0, 0), Arrays.asList(0, 1), Arrays.asList(1, 0)) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( r.polygon(Arrays.asList(0, 0), Arrays.asList(0, 1), Arrays.asList(1, 0), Arrays.asList(0, 0)) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( r.polygon(Arrays.asList(0, 0), Arrays.asList(0, 1), Arrays.asList(1, 0), Arrays.asList(-1, 0.5)) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( r.polygon(Arrays.asList(0, 0), Arrays.asList(0, 1), Arrays.asList(0)) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( r.polygon(Arrays.asList(0, 0), Arrays.asList(0, 1), Arrays.asList(0, 1, 0)) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( r.polygon(r.point(0, 0), r.point(0, 1), r.line(Arrays.asList(0, 0), Arrays.asList(0, 1))) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
