    ...
    public class Match : GeneratedTest {
        ...
        public void YamlTest(){
             ...
             
             {
                 ...
                 var expected = r.hashMap("str", "bcde").with("groups", r.array(null, r.hashMap("start", 2).with("str", "cde").with("end", 5))).with("start", 1).with("end", 5);
             ...
             
             {
                 ...
                 var expected = r.array(r.hashMap("id", 0).with("a", "abc"), r.hashMap("id", 1).with("a", "ab"), r.hashMap("id", 2).with("a", "bc"));
             ...
             
             {
                 ...
                 var expected = r.array(r.hashMap("id", 0).with("a", "abc"), r.hashMap("id", 1).with("a", "ab"));
             ...
             
             {
                 ...
                 var expected = r.array(r.hashMap("id", 1).with("a", "ab"));
