    ...
    public class MutationDelete : GeneratedTest {
        ...
        public void YamlTest(){
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("deleted", 49).with("replaced", 0.0).with("unchanged", 0.0).with("errors", 0.0).with("skipped", 0.0).with("inserted", 0.0);
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("deleted", 50).with("replaced", 0.0).with("unchanged", 0.0).with("errors", 0.0).with("skipped", 0.0).with("inserted", 0.0);
             ...
             
             {
                 ...
                 var expected_ = err("ReqlQueryLogicError", "Expected type SELECTION but found DATUM:", r.array(0));
