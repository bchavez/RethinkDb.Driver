...
Table tbl2 = (Table) (r.db("test").table("test2"));             
             ...
             
             {
                 ...
                 var expected_ = err("ReqlQueryLogicError", "Durability option `wrong` unrecognized (options are \"hard\" and \"soft\").", r.array(0));
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("deleted", 0.0).with("replaced", 0.0).with("unchanged", 0.0).with("errors", 0.0).with("skipped", 0.0).with("inserted", 2);
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("deleted", 0.0).with("replaced", 0.0).with("unchanged", 0.0).with("errors", 0.0).with("skipped", 0.0).with("inserted", 4);
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("id", 15).with("b", 20);
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("id", 2).with("b", 20);
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("id", 20).with("b", 20);
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("id", 2).with("b", 20).with("c", 30);
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("id", 30).with("b", 20);
             ...
             
             {
                 ...
                 var expected_ = err("ReqlQueryLogicError", "Conflict option `wrong` unrecognized (options are \"error\", \"replace\" and \"update\").", r.array(0));
...
Table tblpkey = (Table) (r.db("test").table("testpkey"));             
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("deleted", 0.0).with("replaced", 0.0).with("generated_keys", arrlen(1, uuid())).with("unchanged", 0.0).with("errors", 0.0).with("skipped", 0.0).with("inserted", 1);
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("deleted", 0.0).with("replaced", 0.0).with("unchanged", 0.0).with("errors", 0.0).with("skipped", 0.0).with("inserted", 7);
             ...
             
             {
                 ...
                 var expected_ = partial(r.hashMap("errors", 1).with("first_error", "`r.minval` and `r.maxval` cannot be written to disk."));
