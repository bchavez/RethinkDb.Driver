    ...
    public class MutationSync : GeneratedTest {
        ...
        public void YamlTest(){
             ...
             
             {
                 ...
                 var expected = r.hashMap("skipped", 0).with("deleted", 0).with("unchanged", 0).with("errors", 0).with("replaced", 1).with("inserted", 0);
...
Table tbl_soft = (Table) (r.db("test").table("test1soft"));             
             ...
             
             {
                 ...
                 var expected = r.array(r.hashMap("ready", true).with("index", "x"));
             ...
             
             {
                 ...
                 var expected = r.hashMap("synced", 1);
