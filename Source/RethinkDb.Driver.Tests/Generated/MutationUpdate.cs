    ...
    public class MutationUpdate : GeneratedTest {
        ...
        public void YamlTest(){
             ...
             
             {
                 ...
                 var obtained = runOrCatch( tbl2.insert(EnumerableLRange(0, 100L).Select(i => r.hashMap("id", i).with("foo", r.hashMap("bar", i))).ToList()) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( tbl.get(12L).update(row => row) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( tbl.get(12L).update(row => r.hashMap("a", row.g("id").add(1L))).optArg("durability", "soft") ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("id", 12L).with("a", 13L);
                 
                 /* Original: tbl.get(12) */
                 var obtained = runOrCatch( tbl.get(12L) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( tbl.get(12L).update(row => r.hashMap("a", row.g("id").add(2L))).optArg("durability", "hard") ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("id", 12L).with("a", 14L);
             ...
             
             {
                 ...
                 var obtained = runOrCatch( tbl.get(12L).update(row => r.hashMap("a", row.g("id").add(3L))).optArg("durability", "wrong") ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( tbl.get(12L).update(row => r.hashMap("a", row.g("id"))) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("id", 12L).with("a", 12L);
             ...
             
             {
                 ...
                 var obtained = runOrCatch( tbl.get(12L).update(r.hashMap("a", r.literal())) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("deleted", 0.0).with("replaced", 10L).with("unchanged", 0L).with("errors", 0.0).with("skipped", 0.0).with("inserted", 0.0);
                 
                 /* Original: tbl.between(10, 20).update(lambda row:{'a':row['id']}) */
                 var obtained = runOrCatch( tbl.between(10L, 20L).update(row => r.hashMap("a", row.g("id"))) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("deleted", 0.0).with("replaced", 0.0).with("unchanged", 10L).with("errors", 0.0).with("skipped", 0.0).with("inserted", 0.0);
                 
                 /* Original: tbl.filter(lambda row:(row['id'] >= 10) & (row['id'] < 20)).update(lambda row:{'a':row['id']}) */
                 var obtained = runOrCatch( tbl.filter(row => row.g("id").ge(10L).and(row.g("id").lt(20L))).update(row => r.hashMap("a", row.g("id"))) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("deleted", 0.0).with("replaced", 10L).with("unchanged", 0.0).with("errors", 0.0).with("skipped", 0.0).with("inserted", 0.0);
                 
                 /* Original: tbl.filter(lambda row:(row['id'] >= 10) & (row['id'] < 20)).update(lambda row:{'b':row['id']}) */
                 var obtained = runOrCatch( tbl.filter(row => row.g("id").ge(10L).and(row.g("id").lt(20L))).update(row => r.hashMap("b", row.g("id"))) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( tbl.between(10L, 20L).update(r.hashMap("a", r.literal())) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( tbl.get(1L).update(r.hashMap("id", 2L).with("d", 1L)) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var expected_ = err("ReqlQueryLogicError", "Could not prove argument deterministic.  Maybe you want to use the non_atomic flag?", r.array(0L));
                 
                 /* Original: tbl.get(1).update({'d':r.js('5')}) */
                 var obtained = runOrCatch( tbl.get(1L).update(r.hashMap("d", r.js("5"))) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( tbl.get(1L).update(r.hashMap("d", tbl.nth(0L))) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( tbl.get(1L).update(r.hashMap("d", r.js("5"))).optArg("non_atomic", true) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("deleted", 0.0).with("replaced", 100L).with("unchanged", 0L).with("errors", 0.0).with("skipped", 0.0).with("inserted", 0.0);
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("deleted", 0.0).with("replaced", 99L).with("unchanged", 1L).with("errors", 0.0).with("skipped", 0.0).with("inserted", 0.0);
                 
                 /* Original: tbl2.update({'foo':{'bar':2}}) */
                 var obtained = runOrCatch( tbl2.update(r.hashMap("foo", r.hashMap("bar", 2L))) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("deleted", 0.0).with("replaced", 0L).with("unchanged", 100L).with("errors", 0.0).with("skipped", 0.0).with("inserted", 0.0);
                 
                 /* Original: tbl2.update({'foo':r.literal({'bar':2})}) */
                 var obtained = runOrCatch( tbl2.update(r.hashMap("foo", r.literal(r.hashMap("bar", 2L)))) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("id", 0L).with("foo", r.hashMap("bar", 2L));
                 
                 /* Original: tbl2.order_by('id').nth(0) */
                 var obtained = runOrCatch( tbl2.orderBy("id").nth(0L) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var obtained = runOrCatch( tbl2.update(r.hashMap("foo", r.hashMap("buzz", 2L))) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("id", 0L).with("foo", r.hashMap("bar", 2L).with("buzz", 2L));
             ...
             
             {
                 ...
                 var obtained = runOrCatch( tbl2.update(r.hashMap("foo", r.literal(1L))) ,
                                            new OptArgs()
                    );
                 assertEquals(expected_, obtained);
             }
             ...
             
             {
                 ...
                 var expected_ = r.hashMap("id", 0L).with("foo", 1L);
