    ...
    public class Timeout : GeneratedTest {
        ...
        public void YamlTest(){
             ...
             
             {
                 ...
                 var expected = err("ReqlQueryLogicError", "JavaScript query `while(true) {}` timed out after 5.000 seconds.", r.array(0.0));
             ...
             
             {
                 ...
                 var expected = err("ReqlQueryLogicError", "JavaScript query `while(true) {}` timed out after 1.300 seconds.", r.array(0.0));
             ...
             
             {
                 ...
                 var expected = err("ReqlQueryLogicError", "JavaScript query `while(true) {}` timed out after 8.000 seconds.", r.array(0.0));
                 
                 //Original: r.js('while(true) {}', timeout=8)
                 var obtained = runOrCatch( r.js("while(true) {}").optArg("timeout", 8.0) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
             ...
             
             {
                 ...
                 var expected = err("ReqlQueryLogicError", "JavaScript query `(function(x) { while(true) {} })` timed out after 5.000 seconds.", r.array(0.0));
             ...
             
             {
                 ...
                 var expected = err("ReqlQueryLogicError", "JavaScript query `(function(x) { while(true) {} })` timed out after 1.300 seconds.", r.array(0.0));
             ...
             
             {
                 ...
                 var expected = err("ReqlQueryLogicError", "JavaScript query `(function(x) { while(true) {} })` timed out after 8.000 seconds.", r.array(0.0));
                 
                 //Original: r.expr('foo').do(r.js('(function(x) { while(true) {} })', timeout=8))
                 var obtained = runOrCatch( r.expr("foo").do_(r.js("(function(x) { while(true) {} })").optArg("timeout", 8.0)) ,
                                            new OptArgs()
                    );
                 assertEquals(expected, obtained);
             }
