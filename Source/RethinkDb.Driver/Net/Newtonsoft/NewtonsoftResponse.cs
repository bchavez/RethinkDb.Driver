...
namespace RethinkDb.Driver.Net.Newtonsoft
{
    ...
    public class NewtonsoftResponse
    {
        ...
        internal virtual bool IsFeed => this.Notes.Any(rn => ExtensionsForResponseNote.IsFeed(rn));
        ...
        {
            string msg = this.Data.Count > 0 ? (string)this.Data[0] : "Unknown error message";
