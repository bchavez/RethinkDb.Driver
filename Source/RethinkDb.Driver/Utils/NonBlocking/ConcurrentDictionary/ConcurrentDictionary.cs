...
namespace RethinkDb.Driver.Utils.NonBlocking.ConcurrentDictionary
{
        ...
        ICollection
    {
        ...
        {
            object oldValObj = DictionaryImpl.ToObjectValue(item.Value);
            return _table.PutIfMatch(item.Key, DictionaryImpl.TOMBSTONE, ref oldValObj, DictionaryImpl.ValueMatch.OldValue);
        }
