...
"rn Expr(value);\r\n        }\r\n\r\n\r\n        public ReqlExpr Row(params object[] valu" +
"es) {\r\n            throw new ReqlDriverError(\"r.row is not implemented in the C#" +
" driver. Use lambda syntax instead.\");\r\n        }\r\n        internal ReqlExpr row" +
"(params object[] values) {\r\n            return Row(values);\r\n        }\r\n\r\n      " +
"  public MapObject HashMap(object key, object val) {\r\n            return new Map" +
"Object().With(key, val);\r\n        }\r\n        internal MapObject hashMap(object k" +
"ey, object val) {\r\n            return new MapObject().With(key, val);\r\n        }" +
"\r\n\r\n        public MapObject HashMap()\r\n        {\r\n            return new MapObj" +
"ect();\r\n        }\r\n        internal MapObject hashMap()\r\n        {\r\n            " +
"return HashMap();\r\n        }\r\n\r\n\r\n        public IList Array(params object[] val" +
"ues){\r\n            return values.ToList();\r\n        }\r\n        internal IList ar" +
"ray(params object[] values){\r\n            return Array(values);\r\n        }\r\n\r\n");
