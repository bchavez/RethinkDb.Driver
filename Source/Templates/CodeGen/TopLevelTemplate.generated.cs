...
"\n\r\n        public ReqlExpr Expr(Object value){\r\n            return Util.ToReqlEx" +
"pr(value);\r\n\r\n        }\r\n        internal ReqlExpr expr(Object value){\r\n        " +
"    return Expr(value);\r\n        }\r\n\r\n\r\n        public ReqlExpr Row(params objec" +
"t[] values) {\r\n            throw new ReqlDriverError(\"r.row is not implemented i" +
"n the C# driver. Use lambda syntax instead.\");\r\n        }\r\n        internal Reql" +
"Expr row(params object[] values) {\r\n            return Row(values);\r\n        }\r\n" +
"\r\n        public MapObject HashMap(object key, object val) {\r\n            return" +
" new MapObject().With(key, val);\r\n        }\r\n        internal MapObject hashMap(" +
"object key, object val) {\r\n            return new MapObject().With(key, val);\r\n " +
"       }\r\n\r\n        public MapObject HashMap()\r\n        {\r\n            return ne" +
"w MapObject();\r\n        }\r\n        internal MapObject hashMap()\r\n        {\r\n    " +
"        return HashMap();\r\n        }\r\n\r\n\r\n        public IList Array(params obje" +
"ct[] values){\r\n            return values.ToList();\r\n        }\r\n        internal " +
"IList array(params object[] values){\r\n            return Array(values);\r\n       " +
" }\r\n\r\n");


            
            #line 86 "..\..\CodeGen\TopLevelTemplate.cshtml"
...
WriteLiteral("    Arguments arguments = new Arguments();\r\n");
            ...
            #line 113 "..\..\CodeGen\TopLevelTemplate.cshtml"
...
WriteLiteral(");\r\n");
            ...
            #line 118 "..\..\CodeGen\TopLevelTemplate.cshtml"
                                }
                                else
                                {
...
WriteLiteral("    return new ");
            ...
            #line 124 "..\..\CodeGen\TopLevelTemplate.cshtml"
                                        Write(Class(term["classname"].ToString()));
...
WriteLiteral("internal ");
            ...
            #line 127 "..\..\CodeGen\TopLevelTemplate.cshtml"
                                  Write(Class(term["classname"].ToString()));
...
WriteLiteral("   return ");
            ...
            #line 129 "..\..\CodeGen\TopLevelTemplate.cshtml"
                                   Write(Method(methodname));
...
WriteLiteral("}\r\n");
            ...
            #line 131 "..\..\CodeGen\TopLevelTemplate.cshtml"
                        }
                    }
                }
            }
